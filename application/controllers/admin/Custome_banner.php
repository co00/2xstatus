...
class Custome_banner extends CI_Controller 
{
	public function __construct()
	{
		parent::__construct();
		$this->base_url = BASE_URL_ADMIN.'Custome_banner/';
        $this->module_name = 'Custome_banner';
	...
	public function index()
	{
        ...
        $data['custome_banner'] = $this->crud->get_one_row('custome_banner',['id'=>1]);
		$this->load->view(ADMIN_VIEW.'custome_banner/index',$data);
	}
    ...
    public function update()
    {
        ...
        if( !$this->form_validation->run() ) {
            ...
            $is_success = $this->crud->update('custome_banner',$post_data,['id' => 1]);
    ...
    public function change_status($id,$status)
    {
        ...
        $success = $this->crud->update('custome_banner', ['status' => $new_status], ['id' => $id]);
        ...
        $response['new_url'] = BASE_URL_ADMIN.'custome_banner/change_status/'.$id.'/'.$new_status;
        echo json_encode($response);
    }
