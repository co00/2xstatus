...
class Videolink extends CI_Controller 
{
    ...
    {
        parent::__construct();
        $this->base_url = BASE_URL_ADMIN.'Videolink/';
        $this->module_name = 'Videolink';
    ...
    public function index()
    {
        ...
        $this->load->view(ADMIN_VIEW.'video/videolink',$data);
    }
    ...
    public function datatable()
    {
        ...
        foreach ($data['data'] as $key => $value) {
            ...
            $edit_url = '<a class="p-5 edit-link" href="'.BASE_URL_ADMIN.'video/videolink/edit_link/'.$value['id'].'"><i class="icon-pencil3"></i></a>';
            ...
            //$temp_row['status'] = '<label class="'.$class.'">'.$text.'</label>';
             ...
             $temp_row['status'] = '<div class="col-md-10 checkbox checkbox-switchery switchery-sm  "><input type="checkbox" class="switchery change_status" '.$checked.' data-href="'.BASE_URL_ADMIN.'video/videolink/change_status/'.$value['id'].'/'.$value['status'].'"></div>';

            $temp_row['action'] = $edit_url;
            $temp_row['action'] .= '<a class="p-5 delete" href="'.BASE_URL_ADMIN.'video/videolink/delete/'.$value['id'].'"><i class="icon-trash"></i></a>';
    ...
    public function change_status($id,$status)
    {
        ...
        $response['new_url'] = BASE_URL_ADMIN.'video/videolink/change_status/'.$id.'/'.$new_status;
        echo json_encode($response);
    }
}
