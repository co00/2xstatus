...
<div class="col-md-6">
	<div class="panel panel-flat">
		<div class="panel-heading">
				<h5 class="panel-title"><b>Custome Banner Ads</b> <button class="btn btn-success pull-right" id="update_image">Update</button></h5>
			...
			<table class="table text-nowrap">
				<tbody>
					<tr class="active border-double">
						...
						<td colspan="5">
							<div class="col-md-10 checkbox checkbox-switchery switchery-sm "><input type="checkbox" class="switchery change_status" <?=($custome_banner->status == '1') ? 'checked' : '' ?>  data-href="<?=BASE_URL_ADMIN.'custome_banner/change_status/'.$custome_banner->id.'/'.$custome_banner->status?>"></div>
						</td>
					</tr>

					<tr class="active border-double">
						<td colspan="10">
							<img src="<?=BASE_URL.BANNER_UPLOADS.$custome_banner->imageurl?>" id="image" style="width: 100%;">
							<br>
							<input type="file" id="imageurl" class="file-styled">
							<input type="hidden" id="old_img" value="<?=$custome_banner->imageurl?>">
						</td>
					</tr>
					...
					<tr class="active border-double">
						...
						<td colspan="5">
							<input type="text" class="form-control" value="<?=$custome_banner->link?>" placeholder="Ads Link" id="link">
						</td>
					</tr>
					...
					<tr class="active border-double">
						...
						<td colspan="5">
							<input type="text" class="form-control" value="<?=$custome_banner->name?>" placeholder="Ads Title" id="name">
						</td>
					</tr>
					...
					<tr class="active border-double">
						...
						<td colspan="5">
							<input type="text" class="form-control " value="<?=$custome_banner->name?>" placeholder="Ads Description" id="description">
						</td>
					</tr>
...
$(document).off('click','#update_image').on('click','#update_image',function(e){
            ...
            if(link == ""){
                ...
                $.ajax({
                    url: '<?=BASE_URL_ADMIN?>Custome_banner/update',
                    type:'POST',
                    dataType: 'JSON',
                    cache: false,
                    contentType: false,
