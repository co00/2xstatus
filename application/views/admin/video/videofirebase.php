...
<!-- <div class="panel panel-flat">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <br>
                    <button id="add_videofirebase" style="width: 100%;" class="btn btn-success">Add</button>
                </div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
        <a href="<?=BASE_URL_ADMIN?>video/firebaseupload" class="btn btn-primary pull-right">Add new</a>
        <br>
...
$(".file-styled").uniform({
        ...
        wrapperClass: 'bg-warning'
         ...
         var table = $('#table').DataTable( {
            ...
            "ajax": {
                "url": "<?=BASE_URL_ADMIN?>video/videofirebase/datatable",
                "type": "POST"
            },
            // "bJQueryUI": true,
        ...
        $(document).off('click','#add_videofirebase').on('click','#add_videofirebase',function(e){

            $.ajax({
                    url: '<?=BASE_URL_ADMIN?>video/videofirebase/store',
                    type:'POST',
                    dataType: 'JSON',
                    data:{
        ...
        $(document).off('click','.updateVideo').on('click','.updateVideo',function(e){
            ...
            $(".loader").removeClass('hidden');
                ...
                $.ajax({
                    url: '<?=BASE_URL_ADMIN?>video/videofirebase/updateLink',
                    type:'POST',
                    dataType: 'JSON',
                    data:{
                        id:$('#id_link').val(),
