...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <br>
                    <button id="add_upload" style="width: 100%;" class="btn btn-success">Add</button>
                </div>

                <div class="col-md-2">
                    <br>
                    <a href="<?=BASE_URL_ADMIN?>comedyvideo/mobileupload" style="width: 100%;" class="btn btn-danger">Mobile Upload</a>
                </div>
...
$(".file-styled").uniform({
        ...
        wrapperClass: 'bg-warning'
         ...
         var table = $('#table').DataTable( {
            ...
            "ajax": {
                "url": "<?=BASE_URL_ADMIN?>comedyvideo/upload/datatable",
                "type": "POST"
            },
            // "bJQueryUI": true,
        ...
        $(document).off('click','#add_upload').on('click','#add_upload',function(e){
        ...
        $(document).off('click','.updateVideo').on('click','.updateVideo',function(e){
            ...
            form_data.append("watermark_status",$('#watermark_status_value').val());
                
                $.ajax({
                    url: '<?=BASE_URL_ADMIN?>comedyvideo/upload/update',
                    type:'POST',
                    dataType: 'JSON',
                    cache: false,
                    contentType: false,
