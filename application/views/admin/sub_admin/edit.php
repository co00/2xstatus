...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>sub_admin/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="mobile" class="form-control file-styled"  value="<?=$result->mobile?>">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="email" class="form-control file-styled"  value="<?=$result->email?>">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="username" class="form-control file-styled" readonly=""  value="<?=$result->username?>">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="password" class="form-control file-styled" >
			...
			?>
						<tr>
							...
							<td class="modules_container">
								...
								<?php
									$is_checked = false;
									if( in_array($value, $sub_admin_modules) ) {
										echo 'checked';
										$is_checked = true;
									}
								?>
							...
							<td class="modules_actions_container">
								<select class="select modules_actions" name="modules_actions[<?=$value?>][]" multiple <?=$is_checked ? '' : 'disabled'?>>
									<?php
									...
									?>
												<option value="<?=$mavalue?>"
													<?php
												if(isset($sub_admin_modules_actions[$value])) {
													if(is_array($sub_admin_modules_actions[$value])) {
														if( in_array($mavalue, $sub_admin_modules_actions[$value]) ) {
															echo 'selected';
														}
													}
												}
